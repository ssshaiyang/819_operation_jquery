...
var tcontent =0;
function getGvalue(gdata, gvariable) {    var gvariableArr = gvariable.split('.');    for(let gvariableEle of gvariableArr) {        gdata = gdata[gvariableEle];    }    return gdata;}
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
	...
	M.prototype.config = {
		...
		}, s.page), s.page.count = tcontent, a.render(s.page))))
